...
![图 13.1 最大的股票交易所（来源：[5]）](../images/v2/chapter13/Figure13.1.png)
...
<div align="center">
  <figure>
    <img src="../images/v2/chapter13/Figure13.2.png" alt="图 13.2：一级行情数据" width="50%">
    <figcaption><p>图 13.2：一级行情数据</p></figcaption>
  </figure>
</div>
...
<div align="center">
  <figure>
    <img src="../images/v2/chapter13/Figure13.3.png" alt="图 13.3：二级行情数据" width="50%">
    <figcaption><p>图 13.3：二级行情数据</p></figcaption>
    </figure>
</div>
...
<div align="center">
  <figure>
    <img src="../images/v2/chapter13/Figure13.4.png" alt="图 13.4：三级行情数据" width="70%">
    <figcaption><p>图 13.4：三级行情数据</p></figcaption>
  </figure>
</div>
...
<div align="center">
  <figure>
    <img src="../images/v2/chapter13/Figure13.5.png" alt="图 13.5：单根 K 线示例" width="50%">
    <figcaption><p>图 13.5：单根 K 线示例</p></figcaption>
  </figure>
</div>
...
![图 13.6：高层设计](../images/v2/chapter13/Figure13.6.png)
...
<div align="center">    
    <figure>
        <img src="../images/v2/chapter13/Figure13.7.png" alt="图 13.7：入站与出站定序器" width="100%">
        <figcaption><p>图 13.7：入站与出站定序器</p></figcaption>
    </figure>
</div>
...
<div align="center">
    <figure>
        <img src="../images/v2/chapter13/Figure13.8.png" alt="图 13.8：客户端网关组件" width="80%">
        <figcaption><p>图 13.8：客户端网关组件</p></figcaption>
    </figure>
</div>
...
![图 13.9：客户端网关](../images/v2/chapter13/Figure13.9.png)
...
![图 13.10：市场数据发布器](../images/v2/chapter13/Figure13.10.png)
...
![图 13.11：报告服务](../images/v2/chapter13/Figure13.11.png)
...
![图 13.12：产品、订单、成交记录](../images/v2/chapter13/Figure13.12.png)
...
![图 13.13：限价订单簿示意图](../images/v2/chapter13/Figure13.13.png)
...
![图 13.14：O(1) 时间复杂度的下单、成交和撤单](../images/v2/chapter13/Figure13.14.png)
...
![图 13.15：单台服务器低延迟交易所设计](../images/v2/chapter13/Figure13.15.png)
...
![图 13.16：订单管理器中的应用循环线程](../images/v2/chapter13/Figure13.16.png)
...
![图 13.17：非事件溯源与事件溯源对比](../images/v2/chapter13/Figure13.17.png)
...
![图 13.18：事件溯源设计](../images/v2/chapter13/Figure13.18.png)
...
![图 13.19：定序器设计示例](../images/v2/chapter13/Figure13.19.png)
...
![图 13.20：热备-温备撮合引擎](../images/v2/chapter13/Figure13.20.png)
...
![图 13.21：Raft 集群中的事件复制](../images/v2/chapter13/Figure13.21.png)
...
![图 13.22：Raft 任期（来源：[23]）](../images/v2/chapter13/Figure13.22.png)
...
![图 13.23：事件溯源中的时间](../images/v2/chapter13/Figure13.23.png)
...
![图 13.24：市场数据发布器](../images/v2/chapter13/Figure13.24.png)
...
![图 13.25：章节总结](../images/v2/chapter13/Figure13.25.jpg)
